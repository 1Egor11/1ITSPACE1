...
class __TwigTemplate_ad18bbeecf7cc3bd1d2fdef35917350b extends Template
{
    private $source;
    private $macros = [];
...
echo _gettext("Your preferences will be saved for current session only. Storing them permanently requires %sphpMyAdmin configuration storage%s.");
            ...
            // line 59
            echo $this->env->getFilter('notice')->getCallable()(twig_sprintf($___internal_parse_0_, (("<a href=\"" . PhpMyAdmin\Html\MySQLDocumentation::getDocumentationLink("setup", "linked-tables")) . "\" target=\"_blank\" rel=\"noopener noreferrer\">"), "</a>"));
            // line 62
            echo "  ";
        }
    }
    ...
    {
        return new Source("", "preferences/header.twig", "D:\\xampp\\phpMyAdmin\\templates\\preferences\\header.twig");
    }
}
