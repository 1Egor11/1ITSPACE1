...
class __TwigTemplate_0bc27a283a3824679c4d94b3854c68ec extends Template
{
    private $source;
    private $macros = [];
...
echo _gettext("Default");
        ...
        ";
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["server"]) {
                ...
                echo "\"";
                echo (((($context["primary_connection"] ?? null) == (($__internal_compile_1 = $context["server"]) && is_array($__internal_compile_1) || $__internal_compile_1 instanceof ArrayAccess ? ($__internal_compile_1["Connection_name"] ?? null) : null))) ? (" selected") : (""));
                echo ">
            ";
                // line 12
...
";
    ...
    {
        return new Source("", "server/replication/replica_configuration.twig", "D:\\xampp\\phpMyAdmin\\templates\\server\\replication\\replica_configuration.twig");
    }
}
