...
class __TwigTemplate_2803e6ac632447d62222303536f276df extends Template
{
    private $source;
    private $macros = [];
...
";
            ...
            // line 43
            echo "  ";
            echo $this->env->getFilter('error')->getCallable()(_gettext("No privileges"));
            echo "
";
        }
    }
    ...
    {
        return new Source("", "server/replication/index.twig", "D:\\xampp\\phpMyAdmin\\templates\\server\\replication\\index.twig");
    }
}
